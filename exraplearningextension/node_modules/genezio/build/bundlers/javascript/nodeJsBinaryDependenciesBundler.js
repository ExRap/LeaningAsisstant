...
class NodeJsBinaryDependenciesBundler {
    ...
    bundle(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logging_1.debugLogger.debug(`[NodeJSBinaryDependenciesBundler] Redownload binary dependencies if necessary for file ${input.path}...`);
            // 4. Redownload binary dependencies if necessary
            yield __classPrivateFieldGet(this, _NodeJsBinaryDependenciesBundler_instances, "m", _NodeJsBinaryDependenciesBundler_handleBinaryDependencies).call(this, input.extra.dependenciesInfo, input.path);
            logging_1.debugLogger.debug(`[NodeJSBinaryDependenciesBundler] Redownload binary dependencies done for file ${input.path}.`);
            return Promise.resolve(input);
        });
    }
}
