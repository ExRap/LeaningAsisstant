...
class NodeTsBinaryDependenciesBundler {
    ...
    bundle(input) {
        ...
        __classPrivateFieldGet(this, _NodeTsBinaryDependenciesBundler_instances, "m", _NodeTsBinaryDependenciesBundler_handleBinaryDependencies).call(this, input.extra.dependenciesInfo, input.path);
        return Promise.resolve(input);
    }
}
