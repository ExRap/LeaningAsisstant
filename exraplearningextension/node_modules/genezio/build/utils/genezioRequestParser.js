...
function bodyIsBinary(contentType) {
    ...
    if (mimeType === "text") {
        ...
        return !["json", "ld+json", "x-httpd-php", "x-sh", "x-csh", "xhtml+xml", "xml"].includes(subType);
}
/**
 ...
 * @param next
 */
function genezioRequestParser(request, response, next) {
...
exports.genezioRequestParser = genezioRequestParser;
